...
void iniciarHD(FILE *HD)
{
    ...
    {
        fwrite(&i, sizeof(int), 1, HD);              //tag
        fwrite(data, sizeof(int), NRO_PALAVRAS, HD); //data
        fwrite(&n_ZERO, sizeof(int), 1, HD);         //atualizado
        fwrite(&n_ZERO, sizeof(int), 1, HD);         //relevancia
        fwrite(&n_ZERO, sizeof(int), 1, HD);         //tempo
    }
