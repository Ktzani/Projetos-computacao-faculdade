...
void unit_Flow_constructor( void){
    ...
    Stock *source = new StockHandle(100);
    Stock *destiny = new StockHandle(400);
    Flow *flu1 = new FlowHandle( source,  destiny, 1, exponencial, true);
...
void unit_Flow_getSource( void){
    ...
    Flow *flu1 = new FlowHandle( source, nullptr);
...
void unit_Flow_getDestiny( void){
    ...
    Flow *flu1 = new FlowHandle(nullptr,  destiny);
...
void unit_Flow_setId( void) {
    ...
    Stock *source = new StockHandle(100);
    Stock *destiny = new StockHandle(400);
    Flow *flu1 = new FlowHandle( source,  destiny);
...
void unit_Flow_setVarBool( void){
    ...
    Stock *source = new StockHandle(100);
    Stock *destiny = new StockHandle(400);
    Flow *flu1 = new FlowHandle( source,  destiny, 1, exponencial);
...
void unit_Flow_execute(void){
    cout << __func__ << "-> INICIO" << endl;
    Stock *source = new StockHandle(100);
    Stock *destiny  = new StockHandle(0);
    Flow *flu1 = new FlowHandle( source,  destiny, 1, exponencial, true);
