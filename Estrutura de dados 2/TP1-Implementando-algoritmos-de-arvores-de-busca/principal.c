...
int main (int argc, const char *argv[]) {
    ...
    switch (metodo){
        ...
        case 2: //Arvore binaria  
           ...
           PreProcessamento = clock();
            arvoreBinaria(nome, quantidade, &contComp, &contTrans);
           PreProcessamento = clock() -PreProcessamento;
    ...
    tPreProce = (((double) PreProcessamento)/1000.0);

    tPesquisa = (((double) Pesquisa)/1000.0);

    tTotal = (tPreProce + tPesquisa)/1000.0;
